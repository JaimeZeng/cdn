...
sudo unzip Notepad2.zip -d /usr/share/notepad2
...
sudo chmod 755 /usr/bin/notepad2
...
sudo chmod 644 /usr/share/pixmaps/notepad2.png
...
sudo chmod 644 /usr/share/applications/notepad2.desktop
